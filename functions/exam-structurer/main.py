...
- In some instances, multiple images could be given/relevant for one question. In these occasions, you have to choose the most important image, and insert that one in the JSON. You are not allowed to include 2 or more image filenames in one individual question. Maximum one per individual question (the most important one).

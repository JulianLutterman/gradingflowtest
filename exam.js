...
const clearLog = (message, targetLog) => { if (targetLog) targetLog.textContent = `> ${message}`; };
const showSpinner = (show, targetSpinner) => { if (targetSpinner) targetSpinner.classList.toggle('hidden', !show); };
